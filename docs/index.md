...
## 主要特性
- 👑 ​**引擎对接**​​：FBX导出支持引擎项目路径 / 其他路径 设置 - new 
- 🚀​ ​**批量处理**​​：同时处理多个FBX/BIP/XAF/选择集/合并/文件
- 🧬 ​**​一键换皮​**​​：快速将动画应用到不同角色模型
- 🗃️ ​**​文件管理系统​​**​：内置资源浏览器（Windows风格操作）、标签分类和智能搜索过滤
- ⚙️ ​​**​可定制UI​**​​：颜色主题、列表布局/自定义颜色字体..等
- 🔌 ​**​​无缝集成​**​​：工具栏菜单和自启动选项
...
| **选择集同步** | 将当前场景文件的选择集同步更新到列表MAX文件 / 支持 批量处理 - NEW
| **合并挂点文件** | 批量合并挂点文件/挂点对齐链接🔗到骨骼 / 支持 批量处理 - NEW
| **改名批量工具** | 联动主插件 可呼出 内置的文件批量改名工具 / 支持 批量处理 - NEW
